...
class Vektor3d{
    ...
    double DajDuzinu() const {return sqrt(koordinate[0]*koordinate[0]+
...
Vektor3d ZbirVektora(const Vektor3d &v1, const Vektor3d &v2 ){
    ...
    v3.koordinate[2]=v2.koordinate[2]+v2.koordinate[2];
